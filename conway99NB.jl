...
# ╔═╡ 11c55411-1c14-4fc0-a576-e454f2f8565e
paley = SimpleGraph(mat)

# ╔═╡ 7ea5015c-030d-4c21-9173-758077efc0b5
graphplot(paley, names=1:9, nodesize=0.2, )

# ╔═╡ 1b1f305a-6a8a-42b0-845d-5efbc10d9744
V = 9

# ╔═╡ 8b91c27b-dd96-433f-ac09-65a293537fb1
E = 4

# ╔═╡ c0cbbaa9-de61-430b-8f24-1f8788eb3b28
g = random_regular_graph(V, E, seed=42)

# ╔═╡ 360b37b6-5ed0-429e-9dce-d28a49bba675
graphplot(g, names=1:V, nodesize=0.2, )

# ╔═╡ b26ff02e-0768-42f3-a7e6-6b8230abfdf1
adjacency_matrix(g)
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "42c9b536f7526e9d2458a093e0142731d7f83d82"
